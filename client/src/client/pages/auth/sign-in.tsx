...
const SignIn = () => {
  ...
  const submit = async (e) => {
    ...
    if (!email || !password) return alert("Please Fill in all the Required Fields First!");
  ...
  return (
    <div>
      ...
      <h2 className="text-center my-5" style={{fontFamily: "Alfa Slab One", }}>Sign In Sir.</h2>
